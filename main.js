// JS main file for Jonathan Bareket's portfolio website
// DOM Elements
document.addEventListener('DOMContentLoaded', () => {
    ...
    navLinks.forEach(link => {
        link.addEventListener('click', (e) => {
            ...
            if (navMenu === null || navMenu === void 0 ? void 0 : navMenu.classList.contains('active')) {
                navMenu.classList.remove('active');
                navToggle === null || navToggle === void 0 ? void 0 : navToggle.classList.remove('active');
            }
